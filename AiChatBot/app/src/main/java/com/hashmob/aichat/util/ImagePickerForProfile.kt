...
class ImagePickerForProfile : DialogFragment(), View.OnClickListener {
    var listener: onUpdate1? = null
    ...
    fun setListener(listener: onUpdate1) {
            ...
            if (requestCode == RESULT_LOAD_IMAGE) {
                if (data != null) {
                    ...
                    if (uri != null) {
                        ...
                        try {
                            if (imgPath != null && imgPath!!.contains("mp4")) {
                                ...
                                if (duration / 1000 <= 30) {
                                    Toast.makeText(
                                        context,
                                        "Please choose video with max 30 sec length.",
                                        Toast.LENGTH_SHORT
                                    ).show()
                                    videoPath = imgPath
                                } else {
                        ...
                        if (listener != null) {
                            listener!!.set(imgPath!!, videoPath!!)
                        }
                        dismiss()
                    } else {
                        Log.e(TAG, "uri null: ")
...
//          write the compressed bitmap at the destination specified by filename.
    ...
    // Interface
    interface onUpdate1 {
        fun set(imagePath: String, videoPath: String)
    }
